...
export const order = <i className="fa-solid fa-list-check"></i>
export const expenses = <i className="fa-solid fa-money-bill-transfer"></i>
export const complaint = <i className="fa-solid fa-triangle-exclamation"></i>
...
export const freelance = <i className="fa-solid fa-earth-americans"></i>
...
export const user = <i className="fa-solid fa-users-between-lines"></i>
