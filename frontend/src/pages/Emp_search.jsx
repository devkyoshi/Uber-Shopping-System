...
export default function Emp_search() {
  ...
  useEffect(() => {
    ...
    const fetchAnnouncements = async () => {
      ...
      const res = await fetch(`/api/announcement/getannouncement?${searchQuery}`);
      if (!res.ok) {
  ...
  const handleSubmit = (e) => {
    ...
    const searchQuery = urlParams.toString();
    navigate(`/Emp_search?${searchQuery}`);
  };
      ...
      <form className='flex flex-col gap-8'onSubmit={handleSubmit}>
        ...
        <div className='flex items-center gap-2'>
          ...
          >
            ...
            <option value='Promotions'>Promortions</option>
          </Select>
        </div>
