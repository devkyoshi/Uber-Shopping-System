...
export default function Employee_Registration() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.username ||!formData.email ||!formData.password |!formData.Emp_Name ||!formData.Emp_Age ||!formData.Emp_Gender ||!formData.Emp_Address ||!formData.Emp_CNumber) {
...
<div  className='min-h-screen ' style={{ 
  ...
  <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-2 '>
     ...
     <Link to='/' className='font-bold dark:text-white text-4xl'>
      <span className='px-2 py-1 bg-gradient-to-r from-pink-500 via-red-500 to-orange-500 rounded-lg text-white '>Uber
</span>
Shopping</Link>
