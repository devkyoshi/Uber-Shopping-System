  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label>
          Purchase Amount:
          <input type="text" name="purchase_amount" value={formData.purchase_amount} onChange={handleChange} />
        </label>
        {/* Other Order Details */}
        ...
        <label>
          Email:
          <input type="email" name="cash_payment.email" value={formData.cash_payment.email} onChange={handleChange} />
        </label>
        ...
        <label>
          Email:
          <input type="email" name="card_payment.email" value={formData.card_payment.email} onChange={handleChange} />
        </label>
