          ...
          <SideBar/>
            <div className='inner-layout'>
              <Typography variant="h3" style={{ color: 'var(--logo-green1)' }} className="ml-3">Complaint Form</Typography>
                ...
                <br/>
                  <form onSubmit={handleSubmit} className="max-w-720px mx-auto space-y-5 p-5">
                    <div className="grid grid-cols-2 gap-10 mb-1">
                      <div>
                        <div className="mb-3">
                        <Typography htmlFor="orderId" className="block mb-2 font-bold">Customer Name:</Typography>
                        <Typography><input type="text" id="orderId" name="order_id" value={currentCustomer.cus_name} onChange={handleChange} className="w-full p-1 bg-red-45 border border-gray-400 rounded-md" required readOnly /></Typography>
                        </div>
                        <div className="mb-3">
