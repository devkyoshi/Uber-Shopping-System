...
export default function About() {
  return (
    <div className='inner-layout'>
      ...
      That's where we come in.Our team works tirelessly to handpick the freshest and highest-quality products for you.From 
      farm-fresh produce to pantry staples and gourment treats,we've got everything you need to create delicious meals and 
      memorable moments at home.</p>
