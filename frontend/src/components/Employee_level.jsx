...
export default function Employee_level() {
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full flex gap-7'>
      <div>
            ...
            <div className="border-t border-gray-200">
              <dl>
                <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd className="mt-1 text-sm text-gray-900 sm:col-span-2">3 years</dd>
                </div>
                <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-sm font-medium text-gray-500">Number of Deliveries</dt>
                  <dd className="mt-1 text-sm text-gray-900 sm:col-span-2">500+</dd>
                </div>
                <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
