...
import { HiUser, HiCurrencyDollar, HiCog, HiChatAlt, HiKey,HiArrowSmRight,HiBadgeCheck  } from 'react-icons/hi';
       ...
       <Sidebar.Items >
        ...
        <Link to='/Dashboard?tab=profile'>
          ...
          <Link to='/Dashboard?tab=Settings'>
            <Sidebar.Item active={tab === 'Settings'} icon={HiCog} label={' '} labelColor={tab === 'Settings' ? 'dark' : 'none'} as='div'>
             Settings
            </Sidebar.Item>
          </Link>
