...
export function AddBranch() {
    ...
    useEffect(() => {
        const fetchDistricts = async () => {
            try {
                ...
                const districtValues = [...new Set(branches.map(branch => branch.district))];
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const isExists = branches.some(branch => (branch.branch_ID === formData.branch_ID) || (branch.branch_Location === formData.branch_Location));
            ...
            const response = await axios.post("http://localhost:8070/Branch/branch-add", formData);
    ...
    return (
        <Card color="transparent" shadow={false}>
            ...
            <div className="flex items-center justify-center h-full">
                <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96 center" onSubmit={handleSubmit} required>
