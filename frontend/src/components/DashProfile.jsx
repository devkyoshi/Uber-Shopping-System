...
export default function DashProfile() {
    ...
    setUpdateUserSuccess(null);
        ...
        try {
          ...
          const res = await fetch(`http://localhost:8070/Employee/user/update/${currentUser._id}`,
           {
            method: 'PUT',
            headers: {
      ...
      const handleDeleteUser = async () => {
        ...
        try {
          ...
          const res = await fetch(`http://localhost:8070/Employee/user/delete/${currentUser._id}`, {
            method: 'DELETE',
          });
          const data = await res.json();
          if (!res.ok) {
 ...
 >
            <img src={ 'https://i.pinimg.com/originals/a1/f0/32/a1f03245d58d19e105ce76a733cc7563.jpg'} alt='user' className='rounded-full w-full h-full object-cover border-8 border-[lightgray]' 
             />
